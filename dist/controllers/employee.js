...
class EmployeeController {
    ...
    static addEmployee(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const existingEmployee = yield _models_1.Employee.findOne({ employeeNo });
                if (existingEmployee) {
                    return res.status(400).json({
                        message: "Employee number already in use. Please choose a unique number.",
                    });
                }
    ...
    static updateEmployee(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let { id, firstName, lastName, salutation, gender, employeeNum, grossSalary, profileColour, } = req.body;
                const update = {
                    firstName,
                    lastName,
                    salutation,
